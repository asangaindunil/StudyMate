...
import com.bla.studymate.cardviews.adapters.GroupCardAdapter;
...
public class GroupsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        groupList.add(new Group("SLIIT 2018 B1",23, 4));
        groupList.add(new Group("SLIIT Programming bros",2, 12));

        //set adapter to recyclerview
        mAdapter = new GroupCardAdapter(groupList, getActivity());
